                                    ...
                                    <article class="group w-full max-w-[92%] border px-3 py-2.5 shadow-sm sm:w-auto sm:max-w-[65%] {{ $bubbleClasses }}">
                                        <div class="flex items-start justify-between gap-2">
                                            <div class="min-w-0">
                                                ...
                                                @if ($message->body)
                                                    <p class="mt-1 whitespace-pre-line text-[13px] leading-5 sm:text-[14px]">
                                                        {{ $message->body }}
                                                    </p>
                                                @endif
                                            </div>
                    ...
                    @if ($canSend)
                        ...
                        >
                            ...
                            <div class="rounded-2xl border border-gray-200 bg-gray-50 p-2.5 dark:border-white/10 dark:bg-white/5">
                                ...
                                <div class="mt-2.5 flex flex-wrap items-center justify-between gap-2.5 border-t border-gray-200 pt-2.5 dark:border-white/10">
                                    <label class="inline-flex h-8 cursor-pointer items-center gap-1.5 rounded-xl border border-gray-200 bg-white px-2.5 text-[12px] font-medium text-gray-700 transition hover:bg-gray-50 dark:border-white/10 dark:bg-white/10 dark:text-white">
